class Node:
   ...
   def replace_node_in_parent(self, pointer):
      ...
      if pointer != None:
         ...
         print(self.parent.getRootData(), "is now the parent of", self.getRootData())
   ...
   def delete(self, item):
      ...
      if item < self.getRootData():
         ...
         if self.left != None and self.right != None:
            ...
            print("This node has two children:", self.left.getRootData(), self.right.getRootData())
            successor = self.right.find_min()
            print("Sucessor is:", successor.getRootData())
            ...
            print("This node has a left child:", self.left)
